...
const App = () => {
    ...
    return (
        <cellsContext.Provider value={{state,dispatch,ACTIONS}}>
            <div className="App min-h-lvh lg:px-32 xl:px-60 pb-4 bg-gray flex flex-col gap-8">
                <h1 className="text-4xl font-bold flex items-center justify-center text-center h-24">Ultimate Tic-Tac-Toe</h1>
